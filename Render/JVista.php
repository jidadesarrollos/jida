...
class JVista {
     ...
     *
     * @param mixed $ejecucion Arreglo de datos o string con nombre del Objeto y metodo sobre el cual se obtendrá la información a usar en la vista El valor retornado por el objeto debe ser el objeto
     *
