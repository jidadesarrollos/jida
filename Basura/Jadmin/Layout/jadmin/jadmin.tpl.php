...
<div class="jida-container">
    ...
    <div id="content-wrapper" class="short-menu">
        ...
        <aside class="aside row-offcanvas-left">
            ...
            <?PHP
            $showMenu = (array_key_exists('showmenu',
                                          $_GET) and $_GET['showmenu'] == 'true') ? 'long-menu 1' : 'short-menu';

            $menuControl = new \Jida\RenderHTML\MenuHTML('Principal');
            $menuControl->configuracion['ul'][0] = [
                "class" => "nav nav-aside menu $showMenu",
                'id'    => 'step1',
                'name'  => 'step1'
            ];
            $menuControl->configuracion['li'][0] = [
                'class' => "li-parent",
                'data-liparent' => 'true'
            ];
