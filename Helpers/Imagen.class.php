...
class Imagen extends Archivo {
	 ...
	 * @param string $nombreImagen [opcional] Nombre de la imagen, sino es pasado se asume que el nombre viene incluido
	 *                             en la variable $url
	 */
	 ...
	 * @param string $directorio Ruta destino de las imagenes generadas, si no se especifica, las imagenes se generan
