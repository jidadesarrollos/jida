 ...
 * Crea Controles HTML
 *
 * @internal Genera controles HTML con todas las especificaciones requeridas basada en estandards HTML5.
 *
 ...
 * Campos Compuestos:
 *
 * Documentacion(Para cedulas y rif)
 *
 * @package default
 * @author
 *
...
use Jida\BD as BD;
class CampoHTML extends BD\DBContainer {
    /**
     ...
     *
     * @var int $visibilidad 1 = Normal,2 = Readonly,3 = Disabled
	 *
     */
    var $visibilidad = 1;
