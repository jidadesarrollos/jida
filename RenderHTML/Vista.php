 ...
 *
 * @internal Permite configurar un Grid (Vista) personalizado, basado en un query a una
...
class Vista extends BD\DBContainer {
    ...
    /**
     * var mixed $filtroFecha FALSE si no es utilizado, caso contrario debe llevar el nombre del campo por el cual se
     * filtra
     */
     ...
     * @param array  $arregloConfiguracion Puede ser pasado el arreglo de configuración de la vista completo el cual
     *                                     debe tener un key
     *                                     'paginador' para la configuración del mismo, caso contrario será tomado como
     *                                     el arreglo de configuración del paginador
     * @param string $nombreVista          Nombre de la vista
     * @param mixed  $global               Arreglo o nombre del key del arreglo global para la configuración de la
     *                                     vista
     */
