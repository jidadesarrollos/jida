<div id="jidaGestionCampos" data-formulario="<?=$this -> idFormulario ?>">
    ...
    <div class="alert alert-info">
        ...
        <ol>
            <li>
                <strong>Si deseas editar el orden de los campos</strong> Haz click en el bot&oacute;n <strong>Editar Orden</strong> que se
                encuentra al final de la lista de campos y luego haciendo click en cada campo colocalo en la posicion que deseas.
            </li>
            <li>
    ...
    <div class="row">
        <div class="col-md-3 col-xs-12 col-sm-3">
            ...
            data-url="/jadmin/formularios/campos/configuracion/<?=$this -> idFormulario ?>">
                <?php 
